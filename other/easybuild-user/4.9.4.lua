...
local root = cpe .. "other/easybuild/4.9.4/"
...
setenv("EASYBUILD_PARALLEL","32")
setenv("EASYBUILD_RECURSIVE_MODULE_UNLOAD", "False")
setenv("EASYBUILD_INSTALLPATH", local_user)
setenv("EASYBUILD_CONTAINERPATH", pathJoin(local_user, "containers"))
setenv("EASYBUILD_REPOSITORYPATH", pathJoin(local_user, "ebfiles_repo"))
